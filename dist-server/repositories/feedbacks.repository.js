...
var FeedbacksRepository = /*#__PURE__*/function () {
  ...
  _createClass(FeedbacksRepository, [{
    key: "findAll",
    value: function () {
      var _findAll = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var feedbacksCollection;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return (0, _conn.getFeedbacksCollection)();
              case 2:
                feedbacksCollection = _context.sent;
                console.log(feedbacksCollection);
                return _context.abrupt("return", feedbacksCollection);
              case 5:
              case "end":
...
var feedbacksRepository = new FeedbacksRepository();
